// https://etherscan.io/address/0x559cc6564ef51bd1ad9fbe752c9455cb6fb7feb1#code
...
contract GuessNumber {
  ...
  function guessNumber(uint256 _number) public payable {
    ...
    guessHistory.number = _number; /** DEV COMMENT: randomNumber = player, _number must equal randomNumber --> player must equal _number which is less than 10, which is impossible  */
